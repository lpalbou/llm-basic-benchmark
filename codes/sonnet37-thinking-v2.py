...
# Triangle properties
# Make sure to use float type for the center
triangle_center = np.array([WIDTH // 2, HEIGHT // 2], dtype=float)  # Center of rotation
...
ball_pos = triangle_center.copy()  # Start at the center of the triangle - this will now be float
